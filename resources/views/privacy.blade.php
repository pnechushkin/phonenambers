...
@section('content')
    <div class="row">
        ...
        <p>Effective date: April 09, 2017</p>


        <p>Canada Phone Numbers Lookup ("us", "we", or "our") operates the https://canadaphones.info website (the
            "Service").</p>

        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you
            use our Service and the choices you have associated with that data. Our Privacy Policy for Canada Phone
            Numbers Lookup is managed through Canada Privacy Policy.
        </p>
        ...
        <p>Canada Phone Numbers Lookup uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement
            to that transfer.</p>
        <p>Canada Phone Numbers Lookup will take all steps reasonably necessary to ensure that your data is treated
        ...
        <p>Canada Phone Numbers Lookup may disclose your Personal Data in the good faith belief that such action is
            necessary to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Canada Phone Numbers Lookup</li>
        ...
        <ul>
            <li>By email: info@canadaphones.info</li>
